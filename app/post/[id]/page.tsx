  ...
  return (
    <main className="min-h-screen max-w-lg mx-auto pb-32">
      ...
      <div className="card m-4 p-4">
        ...
        <div className="flex gap-5 text-sm text-white/50 pt-2 border-t border-white/10 mt-2 pt-3">
          <button onClick={handleVote} className="hover:text-white">🔥 {post.yeahs}</button>
